  ...
  projects: Project[] = [
    {
      ...
      fecha_fin: '03-2026',
      title: { es: 'FlexemCar — Chatbot & Automatización', en: 'FlexemCar — Chatbot & Automation' },
      description: {
    ...
    {
      id: 3,
      fecha_creacion: '03-2025',
      fecha_fin: '06-2025',
      title: { es: 'Hairbooking', en: 'Hairbooking' },
      description: {
        es: 'Sistema multiusuario de reservas para barberías que elimina solapamientos y automatiza recordatorios.',
        en: 'Multi-user reservation system for barbershops that eliminates overlaps and automates reminders.'
      },
